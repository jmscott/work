...
<div class="examples">
 <h3>Examples</h3>
 <dl>
   <dt><a href="/cgi-bin//env?out=text&name=REQUEST_METHOD">
env?out=text&#38;name=REQUEST_METHOD</a></dt>
   <dd>Write a text chunk that is the value of the REQUEST_METHOD environment
    variable.</dd>
   <dt><a href="/cgi-bin//env?out=input&name=dog&src=QS&dog=bark&id=pet&type=text&ro=yes">
env?out=input&#38;name=dog&#38;src=QS&#38;dog=bark&#38;id=pet&#38;type=text&#38;ro=yes</a></dt>
   ...
   <dt><a href="/cgi-bin//env?out=input&src=QS&type=hidden&name=state&state=TX">
env?out=input&#38;src=QS&#38;type=hidden&#38;name=state&#38;state=TX</a></dt>
   <dd>Write an html &#60;input&#62; element of type &#34;hidden&#34; seeded the
    ...
    query arguments.</dd>
   <dt><a href="/cgi-bin//env?out=dl&class=system&id=process-env">
env?out=dl&#38;class=system&#38;id=process-env</a></dt>
   <dd>Write out a &#60;dl&#62; of all the environment variables, 
    tagged with id &#34;process-env&#34; and class &#34;system&#34;</dd>
   <dt><a href="/cgi-bin//env?out=text&name=foo&foo=Bar&src=QS">
env?out=text&#38;name=foo&#38;foo=Bar&#38;src=QS</a></dt>
