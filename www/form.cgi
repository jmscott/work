...
<POST>
 <in>
  ...
  >
   ...
   <synopsis>
    This form demonstrates validation of posted values
    against the patterns defined in perl5_re.
   </synopsis>
   <vars>
    <var
    	name="religion"
	required="yes"
	perl5_re="jewish|christian|muslim|hindu|buddhist|agnostic|atheist"
    />
   </vars>
  </putter>
 </in>
